...
import re
import os.path
f = open("G:\\blender\\blender1_with_london\\londonjpg\\SHU\\data.txt","r")
...
for i in range(1361,1383):
    loc = "G:\\blender\\blender1_with_london\\londonjpg\\SHU\\IMAG"
    loc += str(i)
    loc += ".jpeg"
    if os.path.isfile(loc) :
        ...
        ob.rotation_euler[1] = math.radians(0)
        ob.rotation_euler[2] = math.radians(270)
